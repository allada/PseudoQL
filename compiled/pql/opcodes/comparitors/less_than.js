...
var LESS_THAN = (function (_COMPARITOR) {
    _inherits(LESS_THAN, _COMPARITOR);

    function LESS_THAN() {
        _classCallCheck(this, LESS_THAN);

        _get(Object.getPrototypeOf(LESS_THAN.prototype), 'constructor', this).apply(this, arguments);
    }

    _createClass(LESS_THAN, [{
        key: 'getSQL',
