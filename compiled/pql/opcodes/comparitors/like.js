...
var LIKE = (function (_COMPARITOR) {
    _inherits(LIKE, _COMPARITOR);

    function LIKE() {
        _classCallCheck(this, LIKE);

        _get(Object.getPrototypeOf(LIKE.prototype), 'constructor', this).apply(this, arguments);
    }
