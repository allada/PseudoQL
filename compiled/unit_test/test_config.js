...
var _pqlOpcodesComparitorsEqualJs = require('./../pql/opcodes/comparitors/equal.js');

var _pqlOpcodesComparitorsGreater_thanJs = require('./../pql/opcodes/comparitors/greater_than.js');

var _pqlOpcodesComparitorsLess_thanJs = require('./../pql/opcodes/comparitors/less_than.js');

var _pqlOpcodesComparitorsLikeJs = require('./../pql/opcodes/comparitors/like.js');

var _pqlOpcodesComparitorsNo_valueJs = require('./../pql/opcodes/comparitors/no_value.js');

var _pqlOpcodesComparitorsNot_equalJs = require('./../pql/opcodes/comparitors/not_equal.js');

var _pqlOpcodesComparitorsNot_likeJs = require('./../pql/opcodes/comparitors/not_like.js');

var _pqlOpcodesConstants_arrayJs = require('./../pql/opcodes/constants_array.js');

var _pqlOpcodesNullJs = require('./../pql/opcodes/null.js');
...
Config.FUNCTION_MAP = {
    eq: {
        ...
        format: function format(args, orig_args, query_obj) {
            var pql = this.getPqlObj();
            var obj = new _pqlOpcodesComparitorsEqualJs.EQUAL(pql);
    ...
    gt: {
        ...
        format: function format(args, orig_args, query_obj) {
            var pql = this.getPqlObj();
            var obj = new _pqlOpcodesComparitorsGreater_thanJs.GREATER_THAN(pql);
            obj.setLeft(orig_args[0]);
            obj.setRight(orig_args[1]);
            return obj.getSQL(query_obj);
        }
    ...
    lt: {
        ...
        format: function format(args, orig_args, query_obj) {
            var pql = this.getPqlObj();
            var obj = new _pqlOpcodesComparitorsLess_thanJs.LESS_THAN(pql);
            obj.setLeft(orig_args[0]);
            obj.setRight(orig_args[1]);
            return obj.getSQL(query_obj);
        }
    ...
    ne: {
        ...
        format: function format(args, orig_args, query_obj) {
            var pql = this.getPqlObj();
            var obj = new _pqlOpcodesComparitorsNot_equalJs.NOT_EQUAL(pql);
            obj.setLeft(orig_args[0]);
            obj.setRight(orig_args[1]);
            return obj.getSQL(query_obj);
        }
    ...
    like: {
        ...
        format: function format(args, orig_args, query_obj) {
            var pql = this.getPqlObj();
            var obj = new _pqlOpcodesComparitorsLikeJs.LIKE(pql);
            obj.setLeft(orig_args[0]);
            obj.setRight(orig_args[1]);
            return obj.getSQL(query_obj);
        }
    ...
    not_like: {
        ...
        format: function format(args, orig_args, query_obj) {
            var pql = this.getPqlObj();
            var obj = new _pqlOpcodesComparitorsNot_likeJs.NOT_LIKE(pql);
            obj.setLeft(orig_args[0]);
            obj.setRight(orig_args[1]);
            return obj.getSQL(query_obj);
        }
    ...
    'in': {
        ...
        format: function format(args, orig_args, query_obj) {
            ...
            var out_args = [];
            var obj = new _pqlOpcodesComparitorsEqualJs.EQUAL(pql);
            orig_args.splice(1).forEach(function (v) {
                out_args.push(v);
            });
            obj.setLeft(orig_args[0]);
            obj.setRight(new _pqlOpcodesConstants_arrayJs.CONSTANTS_ARRAY(pql, out_args));
            return obj.getSQL(query_obj);
        }
    },
    not_in: {
    ...
    instr: {
        ...
        max_args: 2,
        return_type: Config.NUMERIC,
        arg_types: [Config.STRING, Config.STRING],
    ...
    replace: {
        ...
        min_args: 3,
        max_args: 3,
        arg_types: [Config.STRING, Config.STRING, Config.STRING],
        return_type: Config.STRING,
    ...
    round: {
        ...
        min_args: 1,
        max_args: 2,
        arg_types: [Config.NUMERIC, Config.NUMERIC],
        return_type: Config.NUMERIC,
    ...
    substr: {
        ...
        min_args: 2,
        max_args: 3,
        arg_types: [Config.STRING, Config.NUMERIC, Config.NUMERIC],
        return_type: Config.STRING,
    ...
    date_format: {
        ...
        min_args: 2,
        max_args: 2,
        arg_types: [Config.DATE, Config.STRING],
        return_type: Config.STRING,
    ...
    avg: {
        ...
        min_args: 1,
        max_args: 2,
        arg_types: [Config.NUMERIC, Config.BOOLEAN],
        return_type: Config.NUMERIC,
        is_group_function: true,
        format: {
            1: ['AVG(', Config.ARG1, ')'],
            2: [function (args, orig_args) {
    ...
    group_concat: {
        ...
        min_args: 1,
        max_args: Infinity,
        arg_types: [Config.STRING, Config.BOOLEAN, Config.STRING, Config.STRING, Config.STRING],
        return_type: Config.STRING,
        is_group_function: true,
        format: function format(args, orig_args) {
            var distinct = orig_args.length >= 2 && Boolean(Number(orig_args[1].getValue())) ? 'DISTINCT ' : '';
            var seperator = '';
            if (orig_args.length >= 3) {
                if (!orig_args[2].isConstant() && !orig_args[2].isInstanceOf(_pqlOpcodesNullJs.NULL)) {
                    throw 'Third argument of "group_concat" function must be a constant type';
                }
                if (!orig_args[2].isInstanceOf(_pqlOpcodesNullJs.NULL)) {
                    seperator = ' SEPARATOR ' + args[2];
                }
            }
            var order_bys = new Set();
            if (orig_args.length > 3) {
                ...
                // Inc in order of 2's
                for (var i = 3; i < args.length; i = i + 2) {
                    var dir = 'ASC';
...
Config.COMPARITORS = new Set([_pqlOpcodesComparitorsEqualJs.EQUAL, _pqlOpcodesComparitorsGreater_thanJs.GREATER_THAN, _pqlOpcodesComparitorsLess_thanJs.LESS_THAN, _pqlOpcodesComparitorsLikeJs.LIKE, _pqlOpcodesComparitorsNo_valueJs.NO_VALUE, _pqlOpcodesComparitorsNot_equalJs.NOT_EQUAL, _pqlOpcodesComparitorsNot_likeJs.NOT_LIKE]);